...
class QuizStore extends Flux.Store {
	constructor() {
		...
		this.state = {
			...
			templates: {
				correct: [
					"That's right!",
					"Yes! Maybe you paid attention?",
					"You seem to know most of the anwers",
					"Keep it up!"
				],
				incorrect: [
					"Uhh no.",
					"Nop, you are wrong dude.",
					"Mmmmm... almost there, but no.",
	...
	getRandom(type) {
		const index = Math.floor(
			Math.random() * this.state.templates[type].length
		);
