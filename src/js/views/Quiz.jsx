...
export default class Quiz extends Flux.View {
	...
	componentWillMount() {
		if (this.state.quiz === null)
			this.loadQuiz(this.props.match.params.quiz_id);
	}
	loadQuiz(slug) {
	...
	render() {
		if (this.state.quiz === null || typeof this.state.quiz === "undefined")
			return (
		...
		const slug = match[1];
		if (typeof this.state.quiz.info === "undefined")
			return (
				<div className="p-5 alert alert-error">
					...
					<a
						...
						href="https://github.com/breatheco-de/assets/issues/new"
		...
		return (
			<div className="p-5 text-center">
				...
				<Link
					...
					to={"/" + this.props.match.params.quiz_id + "/start"}>
					Start Quiz
				</Link>
				<LanguageSwitcher
					current={lang}
